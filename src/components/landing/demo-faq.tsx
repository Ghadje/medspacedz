...
const faqs = [
  ...
  },
  {
    ...
    answer: "Absolument ! Medscope est entièrement responsive et fonctionne parfaitement sur smartphones, tablettes et ordinateurs.",
  },
  {
      ...
      <section id="demo" className="py-24 bg-gradient-to-br from-[#1368E8] to-[#082B66] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
          <div className="mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-extrabold mb-6 text-white leading-tight">Voyez Medscope en action</h2>
